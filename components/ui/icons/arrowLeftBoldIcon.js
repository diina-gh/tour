...
export default function ArrowLeftBoldIcon(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" id="Bold" viewBox="0 0 24 24" className={props.customClass} fill="currentColor">
