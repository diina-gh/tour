...
export default function BuildingBoldIcon(props) {
    return (
        <Svg id="Layer_1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" className={props.customClass} fill="currentColor">
