...
export default function CalendarBoldIcon(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" id="Bold" viewBox="0 0 26 26" className={props.customClass} fill="currentColor">
