...
export default function SodaBoldIcon(props) {
    return (
        <Svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 24 24" className={props.customClass} fill="currentColor">
