  ...
  return (
    <SafeAreaView style={[Styles.container, styles.fontFamily]} >
        ...
        <ScrollView showsVerticalScrollIndicator={false} className="w-full h-full px-4 py-4 bg-[#fef9f6]">
          ...
          <View className="w-full bg-[#f4f2ef] border border-0.5 border-[#f0f0f0] rounded-xl shadow-xs items-center py-4 px-4 pb-9">
          ...
          <View className="mt-10 px-1">
            ...
            <Pressable className="flex flex-row justify-between text-gray-900 px-1.5 py-4">
